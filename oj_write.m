function [] = oj_write(jobsdir, myfunc, varargin)
% Writes out the auxiliary files for a single opusjob.
% 
% OJ_WRITE(JOBSDIR, MYFUNC, ...)
%
% Creates the necessary files in the opusjob directory JOBSDIR to
...
%
% Note that a lot of the advanced functionality of opusjobs is
...
%   OPUSJOBS. If unspecified, a name will automatically be
...
%
% See OPUSJOBS for examples of how to use this function and others.
%
% See also:
